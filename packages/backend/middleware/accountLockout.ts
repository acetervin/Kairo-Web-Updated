...
const failedAttempts: Map<string, FailedLoginAttempt> = new Map();
...
module.exports = { checkAccountLockout, checkAccountLockoutSync, recordFailedLogin, recordSuccessfulLogin, MAX_FAILED_ATTEMPTS };