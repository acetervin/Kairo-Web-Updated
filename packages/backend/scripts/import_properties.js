...
async function main() {
  const file = path.join(process.cwd(), 'packages', 'frontend', 'src', 'data', 'properties.json');
  ...
  const imagesFile = path.join(process.cwd(), 'packages', 'frontend', 'src', 'data', 'property-images.json');
