...
(async () => {
  try {
    ...
    const jsonProps = JSON.parse(fs.readFileSync('client/src/data/properties.json', 'utf8'));
    const jsonImgs = JSON.parse(fs.readFileSync('client/src/data/property-images.json', 'utf8'));
